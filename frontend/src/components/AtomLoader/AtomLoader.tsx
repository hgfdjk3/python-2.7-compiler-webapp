...
export const AtomLoader: React.FC<AtomLoaderProps> = ({
  ...
  return (
    <div
      className={`atom-loader-container ${className}`}
      style={{ width: size, height: size }}
    >
      <motion.svg
        className="atom-loader-svg"
        viewBox="0 0 250 250"
        fill="none"
      ...
      >
        <motion.path
          ...
          transition={{
            pathLength: { duration: 1.5, bounce: 0.5, delay: 0, repeatDelay: 0.1, ease: "easeInOut", repeat: Infinity, type: "tween", repeatType: "reverse" },
